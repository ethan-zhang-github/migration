...
public class PipeTaskAttributes {
    ...
    public static PipeTaskAttributes of(PipeTask<?, ?> task) {
        ...
        attributes.set(AttributeType.READ_COUNT, task.getContext().getReaderCounter());
        attributes.set(AttributeType.PROCESSED_COUNT, task.getContext().getProcessorCounter());
        attributes.set(AttributeType.WRITTEN_COUNT, task.getContext().getWriterCounter());
        ...
        attributes.set(AttributeType.START_TIME, task.getContext().getStartTime());
        attributes.set(AttributeType.FINISH_TIME, task.getContext().getFinishTime());
